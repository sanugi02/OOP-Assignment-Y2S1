...
<%@ include file="header.jsp" %>
    <div class="container">
        ...
        <p class="heading"> HOTEL OFFERS</p>
        <h1 class="title">PROMOTIONS</h1>
        <p class="description">
            Visit our five-star city property and take advantage of some exciting hotel offers.
            Here, you will find a list of all our ongoing offers, events, and happenings at the TheCrownCrest.
            From brunch to high tea, spa promotions, and wedding offers, your choice is endless here in the city’s preferred hotel.
        </p>
            ...
            <div class="offer-card">
                ...
                <div class="offer-content">
                    ...
                    <div class="buttons">
                        ...
                        <a href="diining.html" class="know-more">View more &gt;</a>
                    </div>
                </div>
            </div>
        </div>
